...
/*              Anukool Lakhina                                             */
/*  Modified:   Soroush Haeri 31/03/2015                                    */
/*              Changes were applied to make it C++11 compliant             */
...
RouterWaxPar::RouterWaxPar(int n, int hs, int ls, int np, int ig, int m_edges, double a, double b,
...
ASWaxPar::ASWaxPar(int n, int hs, int ls, int np, int ig, int m_edges, double a, double b, int bw,
...
RouterBarabasiAlbert_1_Par::RouterBarabasiAlbert_1_Par(int n, int hs, int ls, int np, int m_edges,
                                                       int bw, double bw_min, double bw_max)
{
    HS = hs;
    LS = ls;
...
RouterBarabasiAlbert_2_Par::RouterBarabasiAlbert_2_Par(int n, int hs, int ls, int np, int m_edges,
                                                       int bw, double bw_min, double bw_max,
                                                       double prob_p, double prob_q)
{
    HS = hs;
    LS = ls;
    N = n;
...
ASBarabasiAlbert_1_Par::ASBarabasiAlbert_1_Par(int n, int hs, int ls, int np, int m_edges, int bw,
                                               double bw_min, double bw_max)
{
    HS = hs;
    LS = ls;
...
ASBarabasiAlbert_2_Par::ASBarabasiAlbert_2_Par(int n, int hs, int ls, int np, int m_edges, int bw,
                                               double bw_min, double bw_max, double prob_p,
                                               double prob_q)
{
    HS = hs;
    LS = ls;
...
TopDownPar::TopDownPar(int ec, int K, int bw_inter, double bw_inter_min, double bw_inter_max,
...
BottUpPar::BottUpPar(int gm, int at, int m, int bw_inter, double bw_inter_min, double bw_inter_max)
{
    as_nodes = m;
    GM = gm;
    AT = at;
...
ImportedFilePar::ImportedFilePar(string f, FileFormat t, int hs, int ls, int bw, double bw_min,
                                 double bw_max)
{
    filename = f;
    format = t;
...
RouterGLPPar::RouterGLPPar(int n, int hs, int ls, int np, int m_edges, int bw, double bw_min,
...
ASGLPPar::ASGLPPar(int n, int hs, int ls, int np, int m_edges, int bw, double bw_min,
                   double bw_max, double p, double beta)
{
    HS = hs;
    LS = ls;
...
void Parse::ParseIntField(int &v)
{
    ...
    if (i == 0)
        ParseError((char *)"int value", "NULL");
...
void Parse::ParseDoubleField(char *f, double &v)
{
    ...
    i = GetNextToken(toks);
    if (i == 0)
        ParseError((char *)"double value", toks);
...
void Parse::ParseStringField(char *f, string &s)
{
    ...
    i = GetNextToken(toks);
    if (i == 0)
        ParseError((char *)"string field", toks);
...
void Parse::ParseSeed(char *f, unsigned short int seed[])
{
    ...
    i = GetNextToken(toks);
    if (i == 0)
        ParseError((char *)"Seed value", toks);
...
RouterWaxPar *Parse::ParseRouterWaxman()
{
    ...
    ParseIntField((char *)"N", n);
    ParseIntField((char *)"HS", hs);
    ParseIntField((char *)"LS", ls);
    ParseIntField((char *)"NodePlacement", np);
    ParseIntField((char *)"GrowthType", ig);
    ParseIntField((char *)"m", m);
    ParseDoubleField((char *)"alpha", a);
    ParseDoubleField((char *)"beta", b);
    ParseIntField((char *)"BWDist", bw);
    ParseDoubleField((char *)"BWMin", bw_min);
    ParseDoubleField((char *)"BWMax", bw_max);
    ParseStringField((char *)"EndModel");
...
RouterBarabasiAlbert_2_Par *Parse::ParseRouterBarabasiAlbert_2()
{
    ...
    ParseDoubleField((char *)"BWMin", bw_min);
    ParseDoubleField((char *)"BWMax", bw_max);
    ParseDoubleField((char *)"p", p);
    ParseDoubleField((char *)"q", q);
    ParseStringField((char *)"EndModel");
...
TopDownPar *Parse::ParseTopDownHier()
{
    ...
    ParseIntField((char *)"edgeConn", ec);
    ParseIntField((char *)"k", k);
    ParseIntField((char *)"BWInter", bw_inter);
    ParseIntField((char *)"BWInterMin", bw_inter_min);
    ParseIntField((char *)"BWInterMax", bw_inter_max);
    ParseIntField((char *)"BWIntra", bw_intra);
    ParseIntField((char *)"BWIntraMin", bw_intra_min);
    ParseIntField((char *)"BWIntraMax", bw_intra_max);
    ParseStringField((char *)"EndModel");

    try {
        td_par = new TopDownPar(ec, k, bw_inter, bw_inter_min, bw_inter_max, bw_intra,
                                bw_intra_min, bw_intra_max);
    ...
    ParseStringField((char *)"BeginModel");
    ParseIntField((char *)"Name", model);
...
BottUpPar *Parse::ParseBottUpHier()
{
    ...
    ParseIntField((char *)"Grouping", gm);
    ParseIntField((char *)"AssignType", at);
    ParseIntField((char *)"NumAS", as_nodes);
    ParseIntField((char *)"BWInter", bw_inter);
    ParseIntField((char *)"BWInterMin", bw_inter_min);
    ParseIntField((char *)"BWInterMax", bw_inter_max);
    ParseStringField((char *)"EndModel");
    ...
    try {
        bu_par = new BottUpPar(gm, at, as_nodes, bw_inter, bw_inter_min, bw_inter_max);
...
ImportedFilePar *Parse::ParseImportedFile(int model)
{
    ...
    ParseIntField((char *)"Format", t);
    ParseStringField((char *)"File", f);
    ParseIntField((char *)"HS", hs);
    ParseIntField((char *)"LS", ls);
    ParseIntField((char *)"BWDist", bw);
    ParseDoubleField((char *)"BWMin", bw_min);
    ...
    try {
        if_par = new ImportedFilePar(f, (ImportedFilePar::FileFormat)t, hs, ls, bw, bw_min,
                                     bw_max);
...
RouterGLPPar *Parse::ParseRouterGLP()
{
    ...
    ParseDoubleField((char *)"BWMax", bw_max);
    ParseDoubleField((char *)"p", p);
    ParseDoubleField((char *)"BETA", beta);
    ParseStringField((char *)"EndModel");
...
ModelPar *Parse::ParseConfigFile()
{
    ...
    /* First line of file */
    ParseStringField((char *)"BriteConfig");
    ...
    ParseStringField((char *)"BeginOutput");

    /* First output format */
    ParseIntField((char *)"BRITE", brite);

    /* First output format */
    ParseIntField((char *)"OTTER", otter);
   ...
   (although it doesn't do anything them -- use converter scripts..*/
    ParseIntField((char *)"DML", dml);
    ParseIntField((char *)"NS", ns);
    ParseIntField((char *)"Javasim", javasim);

    ParseStringField((char *)"EndOutput");
