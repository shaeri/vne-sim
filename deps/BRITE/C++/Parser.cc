...
void Parse::ParseIntField(int &v) {
  ...
  if (i == 0) ParseError( (char*) "int value", "NULL");
...
void Parse::ParseDoubleField(char* f, double &v) {
  ...
  i = GetNextToken(toks);
  if (i == 0) ParseError((char*) "double value", toks);
...
void Parse::ParseStringField(char* f, string& s) {
  ...
  i = GetNextToken(toks);   
  if ((i == 0) || (toks != "=")) ParseError((char*) "=",  toks);

  i = GetNextToken(toks);   
  if (i == 0) ParseError((char*) "string field",  toks);
...
void Parse::ParseSeed(char* f, unsigned short int seed[]) {
  ...
  if ((i == 0) || (toks != f)) ParseError(f, toks);
  i = GetNextToken(toks);
  if (i == 0) ParseError((char*) "Seed value", toks);
