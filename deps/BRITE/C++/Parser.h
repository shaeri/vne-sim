...
{
   public:
    RouterWaxPar(int n, int hs, int ls, int np, int ig, int m_edges, double a, double b, int bw,
...
{
   public:
    ASWaxPar(int n, int hs, int ls, int np, int ig, int m_edges, double a, double b, int bw,
             double bw_min, double bw_max);
...
{
   public:
    RouterBarabasiAlbert_1_Par(int n, int hs, int ls, int np, int m_edges, int bw, double bw_min,
                               double bw_max);
...
{
   public:
    RouterBarabasiAlbert_2_Par(int n, int hs, int ls, int np, int m_edges, int bw, double bw_min,
...
{
   public:
    ASBarabasiAlbert_1_Par(int n, int hs, int ls, int np, int m_edges, int bw, double bw_min,
                           double bw_max);
    int GetN() { return N; }
    int GetNP() { return NP; }
    int GetM() { return m; }
...
{
   public:
    ASBarabasiAlbert_2_Par(int n, int hs, int ls, int np, int m_edges, int bw, double bw_min,
                           double bw_max, double p, double q);
    int GetN() { return N; }
    int GetNP() { return NP; }
    int GetM() { return m; }
    int GetBW() { return BW; }
...
{
   public:
    TopDownPar(int ec, int K, int bw_inter, double bw_inter_min, double bw_inter_max, int bw_intra,
               double bw_intra_min, double bw_intra_max);
...
{
   public:
    BottUpPar(int gm, int at, int m, int bw_inter, double bw_inter_min, double bw_inter_max);
...
class ImportedFilePar : public ModelPar
{
   public:
    ...
    ImportedFilePar(string f, FileFormat t, int hs, int ls, int bw, double bw_min, double bw_max);
...
{
   public:
    RouterGLPPar(int n, int hs, int ls, int np, int m_edges, int bw, double bw_min, double bw_max,
...
{
   public:
    ASGLPPar(int n, int hs, int ls, int np, int m_edges, int bw, double bw_min, double bw_max,
             double p, double beta);
    int GetN() { return N; }
    int GetNP() { return NP; }
    int GetM() { return m; }
