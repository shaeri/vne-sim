...
namespace vne {
    namespace experiments {
        /**************************************************************
         * This is MCVNE with MCF link embedding No Disk IO
         ***************************************************************/
        template<typename = VYVNRProcDigraph<>>
        class MCVNENodeMCFNoDiskIOLinkExp : public Experiment<VYVNRProcDigraph<>>
        {
        ...
        public:
            MCVNENodeMCFNoDiskIOLinkExp ();
            virtual void statisticsGenerated (Statistics& stat);
            virtual ~MCVNENodeMCFNoDiskIOLinkExp ();
