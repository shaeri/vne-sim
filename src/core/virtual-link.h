...
public:
    ...
    virtual void addHostLink (SubstrateLink<LINKRES...>* _l, std::shared_ptr<Resources<LINKRES...>> _res);
...
template<typename ... LINKRES>
void VirtualLink<LINKRES...>::addHostLink (SubstrateLink<LINKRES...>* _l, std::shared_ptr<Resources<LINKRES...>> _res)
{
    BOOST_LOG_NAMED_SCOPE("VirtualLink::addHostLink")
    substrate_host_links.insert(std::make_pair(_l->getId(), _l));
