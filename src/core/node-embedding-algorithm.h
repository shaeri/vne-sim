...
namespace vne {
    ...
    public:
        ...
        virtual Embedding_Result embeddVNRNodes (std::shared_ptr<VNR_TYPE> vnr) = 0;
        
    protected:
        NodeEmbeddingAlgorithm (NetworkBuilder<SUBSTRATE_TYPE>& _sb) : substrate_network(_sb.getNetwork()) {};
        NodeEmbeddingAlgorithm (std::shared_ptr<SUBSTRATE_TYPE> _sn) : substrate_network(std::move(_sn)) {};
