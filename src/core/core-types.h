...
*/
enum class Entity_t { virt = 0, substrate };
...
enum class Embedding_Algorithm_Types { TWO_STAGE = 0, SINGLE_STAGE };

enum class Link_Embedding_Algo_Types { WITH_PATH_SPLITTING = 0, NO_PATH_SPLITTING };
...
enum class Distribution { UNIFORM = 0, EXPONENTIAL, POISSON };
