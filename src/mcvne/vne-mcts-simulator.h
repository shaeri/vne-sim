...
namespace mcvne
{
        ...
        : public MCTSSimulator
    {
       ...
       protected:
        ...
        virtual std::shared_ptr<std::set<int>> getValidSubstrateNodeIdSetForVNNodeId(
            int vn_id, const std::shared_ptr<std::set<int>> used_sn_ids) const = 0;
        ...
        virtual double calculateFinalReward(
            ...
            const std::map<int, std::list<std::pair<int, std::shared_ptr<Resources<SLINKRES...>>>>>
                *linkMap) const = 0;
    ...
    {
        std::shared_ptr<std::set<int>> validActionSet = getValidSubstrateNodeIdSetForVNNodeId(
            st->getCurrentVNId(), st->getUsedSNIds());
    ...
    VNEMCTSSimulator<Network<SNODECLASS<SNODERES...>, SLINKCLASS<SLINKRES...>>,
                     VNRCLASS<Network<VNODECLASS<VNODERES...>, VLINKCLASS<VLINKRES...>>>>::
        VNEMCTSSimulator(
            std::shared_ptr<VNEMCTSSimulator::SUBSTRATE_TYPE> _substrate_net,
    ...
    template <typename... SNODERES, template <typename...> class SNODECLASS, typename... SLINKRES,
              ...
              template <typename...> class VNODECLASS, typename... VLINKRES,
              template <typename...> class VLINKCLASS, template <typename> class VNRCLASS>
    std::shared_ptr<State> VNEMCTSSimulator<
        Network<SNODECLASS<SNODERES...>, SLINKCLASS<SLINKRES...>>,
        VNRCLASS<Network<VNODECLASS<VNODERES...>, VLINKCLASS<VLINKRES...>>>>::createStartState()
        const
    {
        const std::shared_ptr<std::set<int>> VNNodeIdSet = vnr->getVN()->getNodeIdSet();
        std::shared_ptr<VNENMState> st(
            new VNENMState(VNNodeIdSet, vnr->getId(), vnr->getNodeMap()));
        return st;
    }
    ...
    template <typename... SNODERES, template <typename...> class SNODECLASS, typename... SLINKRES,
              ...
              template <typename...> class VNODECLASS, typename... VLINKRES,
              template <typename...> class VLINKCLASS, template <typename> class VNRCLASS>
    bool VNEMCTSSimulator<Network<SNODECLASS<SNODERES...>, SLINKCLASS<SLINKRES...>>,
                          VNRCLASS<Network<VNODECLASS<VNODERES...>, VLINKCLASS<VLINKRES...>>>>::
        step(std::shared_ptr<State> state, int action, double &reward) const
    {
        ...
        if (st->isTreminal()) {
            std::map<int, std::list<std::pair<int, std::shared_ptr<Resources<SLINKRES...>>>>>
                linkMap;
            Embedding_Result result = link_embedder->embeddVNRLinksForIdSets(
                substrate_net, vnr, st->getNodeMap(), &linkMap);
    ...
    bool VNEMCTSSimulator<Network<SNODECLASS<SNODERES...>, SLINKCLASS<SLINKRES...>>,
                          VNRCLASS<Network<VNODECLASS<VNODERES...>, VLINKCLASS<VLINKRES...>>>>::
        validate(const std::shared_ptr<State> state) const
    {
        std::shared_ptr<VNENMState> st = std::static_pointer_cast<VNENMState>(state);
    ...
    template <typename... SNODERES, template <typename...> class SNODECLASS, typename... SLINKRES,
              ...
              template <typename...> class VNODECLASS, typename... VLINKRES,
              template <typename...> class VLINKCLASS, template <typename> class VNRCLASS>
    void VNEMCTSSimulator<Network<SNODECLASS<SNODERES...>, SLINKCLASS<SLINKRES...>>,
                          VNRCLASS<Network<VNODECLASS<VNODERES...>, VLINKCLASS<VLINKRES...>>>>::
        generateLegal(const std::shared_ptr<State> state, const std::vector<int> &history,
                      std::vector<int> &actions, const Status &status) const
    {
        std::shared_ptr<VNENMState> st = std::static_pointer_cast<VNENMState>(state);
        std::shared_ptr<std::set<int>> validActionSet = getValidSubstrateNodeIdSetForVNNodeId(
            st->getCurrentVNId(), st->getUsedSNIds());
        actions = std::vector<int>(validActionSet->begin(), validActionSet->end());
    }
    ...
    void VNEMCTSSimulator<Network<SNODECLASS<SNODERES...>, SLINKCLASS<SLINKRES...>>,
                          VNRCLASS<Network<VNODECLASS<VNODERES...>, VLINKCLASS<VLINKRES...>>>>::
        generatePreferred(const std::shared_ptr<State> state, const std::vector<int> &history,
                          std::vector<int> &actions, const Status &status) const
    {
